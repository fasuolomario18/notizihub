...
La PlayStation 6 fait l'objet de nombreuses spéculations depuis des mois, et les dernières fuites technologiques apportent enfin des informations précises sur son architecture. Selon plusieurs sources de l'industrie, Sony s'apprête à dévoiler une console révolutionnaire équipée d'une puce personnalisée d'AMD, spécialement optimisée pour l'intelligence artificielle. Cette innovation pourrait redéfinir les standards du gaming et placer la nouvelle génération de consoles au cœur de la révolution de l'IA.
